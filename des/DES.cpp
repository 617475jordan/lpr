...
//desdata DES::getCrypt(desdata m_desData)
//{
//	char in[128], out[128];
//	int m_len = m_desData.m_len;
//	for (int i = 0; i < m_len; i++)
//	{
//		in[i] = m_desData.m_crypt[i];
//	}
//
//	running(in, out, m_desData.m_passwordNum, m_desData.m_type);
//	//m_desData.m_crypt;
//	//string data;
//	for (int i = 0; i < m_len; i++)
//	{
//		//cout << out[i];
//		m_desData.m_crypt[i] = out[i];
//	}
//	return m_desData;
//}

void DES::running(char in[128],char out[128], int num, bool type)
{
	initial(num);
...
char m_key[2][8] = { "we4tg34", "2843ywh" };

void DES::processing(char out[8], char in[8], bool type)
{
...
void DES::initial(int num)
{
	static bool k[64], *kl = &k[0], *kr = &k[28];
	bytetobit(k, m_key[num], 64);
